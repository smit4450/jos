...
mem_init(void)
{
	...
	// Your code goes here:
	struct PageInfo* pgstr = (struct PageInfo*) boot_alloc(npages * sizeof(*pages));
	memset(pgstr, 0, npages);
	pages = pgstr;
...
page_free(struct PageInfo *pp)
{
	...
	if(pp->pp_ref || pp->pp_link) panic("Attempting to free page while page is still in use!");
